...
export const metadata: Metadata = {
  ...
  description:
    "ד״ר יורם הוד — למעלה מ-30 שנות ניסיון ברפואת שיניים. טיפול בילדים, מבוגרים וקשישים באווירה ביתית ורגועה, עם מענה מיוחד למטופלים חרדתיים ולציבור הדתי.",
};
...
const values = [
  ...
  },
  {
    ...
    text: "שיטות מתקדמות ועדינות שמבטיחות חוויה רגועה וללא חרדה.",
  },
  {
    icon: Smile,
    title: "מענה למטופלים חרדתיים",
    text: "גז צחוק, דיקור סיני וטלוויזיה במהלך הטיפול להרגעה מלאה.",
  },
  {
    icon: Baby,
    title: "לכל המשפחה",
              ...
              <div>
                ...
                <Reveal direction="left" delay={0.1}>
                  <div className="mt-6 space-y-5 text-lg leading-relaxed text-ink-soft">
                    <p>
                      עם למעלה מ-30 שנות ניסיון ברפואת שיניים, ד״ר יורם הוד מביא
                    ...
                    <p>
                      ד״ר הוד מתמחה במתן מענה למטופלים חרדתיים ולציבור הדתי
                      והחרדי, באמצעות כלים ייחודיים להרגעה — גז צחוק, דיקור סיני
                      וצפייה בטלוויזיה במהלך הטיפול — כדי שכל ביקור יהיה חוויה
                      נעימה ונטולת כאב.
                    </p>
                  </div>
                </Reveal>
