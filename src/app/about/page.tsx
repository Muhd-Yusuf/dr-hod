              ...
              <div>
                ...
                <Reveal direction="left" delay={0.1}>
                  <div className="mt-6 space-y-5 text-lg leading-relaxed text-ink-soft">
                    ...
                    <p>
                      ד״ר הוד נותן מענה מיוחד למטופלים חרדתיים ולציבור הדתי
                      והחרדי, בטיפול רגוע וללא לחץ. הוא נעזר בדיקור סיני להורדת
                      מתח, בצפייה בטלוויזיה, במספר בדיחות ובכלי NLP — כך שכל ביקור
                      נעשה ללא כאבים, באווירה רגועה ובלי לחץ.
                    </p>
                  </div>
                </Reveal>
