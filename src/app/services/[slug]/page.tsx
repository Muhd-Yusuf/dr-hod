...
const SERVICE_CONTENT: Record<Slug, ServiceContent> = {
  whitening: {
    ...
    paragraphs: [
      "הלבנת שיניים היא אחד הטיפולים האסתטיים המבוקשים ביותר, והיא יכולה לשנות באופן דרמטי את מראה החיוך תוך זמן קצר. במרפאת ד״ר יורם הוד אנו משתמשים בחומרים מתקדמים ובטכנולוגיה עדכנית המבטיחים תוצאות מרשימות תוך שמירה מלאה על בריאות השן והחניכיים.",
      "לפני כל טיפול אנו מבצעים בדיקה יסודית ומתאימים את עוצמת ההלבנה למצב השיניים ולגוון הרצוי. כך אנו מונעים רגישות מיותרת ומבטיחים תוצאה אחידה וטבעית. ניתן לבחור בין הלבנה במרפאה לבין ערכה ביתית בהדרכה צמודה.",
      "תוצאות ההלבנה נשמרות לאורך זמן בעזרת שגרת היגיינה נכונה והימנעות מגורמים מכתימים. אנו מלווים אתכם גם לאחר הטיפול בהמלצות לשימור החיוך הבהיר לאורך שנים.",
    ],
    benefits: [
      "חיוך בהיר ומבריק יותר תוך מספר ביקורים",
      "טיפול עדין השומר על אמייל השן",
      "התאמה אישית של גוון ועוצמה",
      "פתרונות מרפאה וערכות ביתיות מבוקרות",
  ...
  implants: {
    ...
    paragraphs: [
      ...
      "ד״ר יורם הוד מבצע את הליך ההשתלה בתכנון מדויק הכולל הדמיה דיגיטלית והערכת מבנה העצם, לקבלת תוצאה אסתטית ופונקציונלית מיטבית. אנו מקפידים על תהליך נטול כאב ככל הניתן ועל החלמה נוחה ומהירה.",
  ...
  emergency: {
    ...
    paragraphs: [
      ...
      "אנו מבינים שכאב לא ממתין, ולכן אנו זמינים עבורכם ומעניקים יחס אישי, סבלני ומרגיע גם ברגעים הלא נעימים. אל תתמודדו עם הכאב לבד — צרו קשר ונדאג לכם.",
    ],
    benefits: [
  ...
  snoring: {
    ...
    paragraphs: [
      ...
      "הלייזר פועל בעדינות על רקמת החך הרך, מחמם ומחזק אותה, וכך מצמצם את הרטט הגורם לנחירות. הטיפול קצר, נוח, ומתבצע במרפאה ללא הרדמה כללית וללא זמן החלמה משמעותי, כך שניתן לחזור לשגרה כמעט מיד.",
      "מרבית המטופלים מדווחים על שיפור ניכר באיכות השינה כבר לאחר מספר טיפולים. במרפאת ד״ר יורם הוד נבצע הערכה מקדימה כדי לוודא שהטיפול מתאים לכם ונבנה תוכנית מותאמת אישית.",
    ],
    benefits: [
      "טיפול לא פולשני וללא ניתוח",
      "ללא הרדמה כללית וללא זמן החלמה",
      "הפחתה משמעותית בעוצמת הנחירות",
      "שיפור באיכות השינה והערנות ביום",
  ...
  general: {
    ...
    paragraphs: [
      ...
      "טיפולינו כוללים בדיקות מקיפות, ניקוי אבנית והסרת רובד, סתימות אסתטיות, טיפולי שורש והדרכה אישית לשמירה על היגיינת הפה בבית. אנו מאמינים שמניעה היא המפתח, ולכן מקפידים על אבחון מוקדם של בעיות.",
    ...
    benefits: [
      ...
      "טיפולי שורש מדויקים ונטולי כאב",
