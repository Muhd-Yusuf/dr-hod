...
const SERVICE_CONTENT: Record<Slug, ServiceContent> = {
  ...
  snoring: {
    ...
    paragraphs: [
      "הלייזר פועל בעדינות על רקמות החיך הרך, מכווץ וממצק אותן, ומקטין את הרטט שגורם לנחירות ולדום נשימה. הטיפול קצר ונוח, מתבצע במרפאה לחלוטין ללא הרדמה וללא זמן החלמה כלל, חוזרים לשגרה מיד, כאילו לא עברתם טיפול בכלל.",
