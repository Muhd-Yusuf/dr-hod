...
const SERVICE_CONTENT: Record<Slug, ServiceContent> = {
  ...
  snoring: {
    ...
    paragraphs: [
      ...
      "מרבית המטופלים מדווחים על שיפור ניכר באיכות השינה כבר לאחר הטיפול הראשון, ובני/בנות הזוג מדווחים על שינה רגועה ושקטה יותר. במרפאת ד״ר יורם הוד נבצע הערכה מקדימה כדי לוודא שהטיפול מתאים לכם ונבנה תוכנית מותאמת אישית.",
    ],
    benefits: [
