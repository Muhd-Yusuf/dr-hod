...
const SERVICE_CONTENT: Record<Slug, ServiceContent> = {
  ...
  snoring: {
    ...
    paragraphs: [
      "נחירות אינן רק מטרד לבן/בת הזוג — הן עלולות להעיד על איכות שינה ירודה ועל בעיות בריאותיות ועל דום נשימה בשינה. הטיפול בלייזר FOTONA מציע פתרון מתקדם, לא פולשני וללא צורך בניתוח או במכשירים מסורבלים.",
      "הלייזר פועל בעדינות על רקמות החיך הרך, מכווץ ומחזק אותן, ומקטין את הרטט שגורם לנחירות ולדום נשימה. הטיפול קצר ונוח, מתבצע במרפאה לחלוטין ללא הרדמה וללא זמן החלמה כלל — חוזרים לשגרה מיד, כאילו לא עברתם טיפול בכלל.",
    ...
    benefits: [
      ...
      "לחלוטין ללא הרדמה — חוזרים לשגרה מיד",
  ...
  seniors: {
    intro:
      "שיניים בריאות בגיל המבוגר הן הרבה מעבר לחיוך — הן משפיעות ישירות על התזונה, על הבריאות הכללית ועל הביטחון בחיי היומיום.",
    paragraphs: [
      "במרפאת ד״ר יורם הוד אנו מלווים כל מטופל בקצב נוח ובאווירה רגועה, עם פתרונות המותאמים לצרכים הייחודיים של בני הגיל השלישי.",
      "הטיפול כולל שיקום תפקוד הלעיסה, שיקום הפה, וטיפול עדין ורגיש במיוחד למטופלים החווים חרדה דנטלית.",
      "אנו מאמינים שכל מטופל ראוי ליחס אישי, סבלני ומכבד — כדי לשמור על בריאות הפה ואיכות החיים לאורך שנים.",
    ],
    benefits: [
      "התאמה אישית לצרכים של בני הגיל השלישי",
      "קצב טיפול נוח ורגוע",
      "שיקום תפקוד הלעיסה ושיקום הפה",
      "טיפול עדין למטופלים עם חרדה דנטלית",
      "יחס אישי, סבלני ומכבד",
    ],
  },
  general: {
    intro:
